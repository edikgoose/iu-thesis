...
\begin{itemize}
    \item \code{slidingWindowSize}. The duration of time for which errors are counted.
    \item \code{failureRateThreshold}. Percentage of errors for transition to a open state.
    \item \code{waitDurationInOpenState}. The waiting duration before transition from open to half-open state
    \item \code{permittedNumberOfCallsInHalfOpenState}. The number of permitted calls to the half-open state to test whether the circuit breaker can be closed.
\end{itemize}
...
\lstinputlisting[language=Octave, caption=Load configuration, label={lst:load_config}]{code/load.yaml}
...
\lstinputlisting[language=Octave, caption=Configuration of the circuit breaker for the first test, label={lst:cb_1}]{code/cb1.yaml}
...
\lstinputlisting[language=Octave, caption=Configuration of the circuit breaker for the second test, label={lst:cb_2}]{code/cb2.yaml}
...
\lstinputlisting[language=Octave, caption=Configuration of the circuit breaker for the third test, label={lst:cb_3}]{code/cb3.yaml}
\end{minipage}
